...
class SnacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snack" do
    assert_difference('Snack.count') do
      post snacks_url, params: { snack: { brand: @snack.brand, description: @snack.description, price: @snack.price, title: @snack.title, type: @snack.type } }
    end
  ...
  test "should update snack" do
    patch snack_url(@snack), params: { snack: { brand: @snack.brand, description: @snack.description, price: @snack.price, title: @snack.title, type: @snack.type } }
